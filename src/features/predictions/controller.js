...
module.exports = { updateByNameOfLeague, findPredictionById, findByNameOfLeague, addPrediction, getPredicationsApiCall, getAllFetchedPrediction, getAllPredictions };
